...
import kilnspaceImage from '../assets/images/kilnspace.png';
...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    title: 'Soundboks',
    tagline:
      'One design system serving web and native app from a single codebase.',
    meta: {
      client: 'SOUNDBOKS',
  ...
  },
  {
    ...
    tagline:
      'A multilingual platform connecting medicinal cannabis patients with doctors.',
    meta: {
      client: 'NoA Ignite',
  ...
  },
  {
    ...
    title: 'RakatX',
    tagline:
      'Fullstack development on a contract management platform for online tendering.',
    meta: {
      client: 'Mercell',
